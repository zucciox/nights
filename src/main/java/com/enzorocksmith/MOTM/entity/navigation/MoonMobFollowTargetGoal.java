...
public class MoonMobFollowTargetGoal extends Goal {
    ...
    public MoonMobFollowTargetGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;
